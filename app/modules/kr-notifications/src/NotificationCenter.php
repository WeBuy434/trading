...
class NotificationCenter extends MySQL
{
     ...
     */
    public function _sendNotification($title, $content, $icon, $sendpush = true)
    {

        // Add sql notification
        $r = parent::execSqlRequest("INSERT INTO notification_center_krypto (title_notification_center, text_notification_center, date_notification_center, icon_notification_center, id_user)
                                        VALUES (:title_notification_center, :text_notification_center, :date_notification_center, :icon_notification_center, :id_user)",
                                        [
