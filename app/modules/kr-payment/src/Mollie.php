...
class Mollie extends MySQL
{
    ...
    public function _createDeposit($User, $amount){
      ...
      return $this->_getMollieObj()->payments->create(array(
          "amount"      => round($amount_deposit_wfees, 2),
          "description" => $User->_getUserID().' - Deposit '.$this->_getApp()->_formatNumber($amount, 2).'$ (+'.$this->_getApp()->_formatNumber(($amount * ($this->_getApp()->_getFeesDeposit() / 100)), 2).'$ fees)',
