...
try {
    ...
    $CrypoCoin = new CryptoCoin($CryptoApi, $_POST['symb'], null, $App);

    // Init CryptoNotification graph
    $CryptoNotification = new CryptoNotification($_POST['symb'], $User);

    // Create new notification
    $CryptoNotification->_createNotification(($_POST['value'] > 10 ? round($_POST['value'], 2) : $_POST['value']), $CrypoCoin->_getPrice());
