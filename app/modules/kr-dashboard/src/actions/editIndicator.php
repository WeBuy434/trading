...
try {
    ...
    $infosIndicatorSaved = $SqlRequest->querySqlRequest("SELECT * FROM indicators_krypto WHERE key_graph=:key_graph AND symbol_indicators=:symbol_indicators AND key_indicators=:key_indicators",
                                                      [
                                                        'key_graph' => $container,
                                                        'symbol_indicators' => $_POST['indic'],
