...
<section class="kr-thirdparty-setup kr-ov-nblr">
  <section>
    <header>
      <img src="<?php echo APP_URL; ?>/assets/img/icons/trade/<?php echo $Exchange->_getLogo(); ?>" alt="GDAX">
    </header>
    ...
    <form class="kr-thirdparty-setup-form" action="<?php echo APP_URL; ?>/app/modules/kr-trade/src/actions/saveThirdpartySettings.php">
      ...
      <div>
        ...
        <?php if($Exchange->_isActivated() != false): ?>
          <input type="button" class="btn btn-shadow btn-red btn-autowidth" onclick="removeThirdpartySetup('<?php echo App::encrypt_decrypt('encrypt', $Exchange->_getExchangeName().'-'.$User->_getUserID()); ?>');" name="" value="Remove">
        <?php endif; ?>
