...
<section class="kr-balance-trhistory-empty">
  <span>Transactions history is empty.</span>
</section>
<?php else: ?>
  ...
  <div>
    ...
    <div>
      <?php if($dataHisto['type_histo'] == "deposit"): ?>
        <span class="kr-balance-trhistory-histo-dep">+<?php echo $App->_formatNumber($dataHisto['amount_histo'], 2); ?> $</span>
      <?php else: ?>
        <span>-<?php echo $App->_formatNumber($dataHisto['amount_histo'], 2); ?> $</span>
      <?php endif; ?>
    </div>
  </div>
  <?php
