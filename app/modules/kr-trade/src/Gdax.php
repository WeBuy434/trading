  ...
  public function _getApi(){
    ...
    if(!is_null($this->Credentials)){
      $this->Api = new \ccxt\gdax([
        'apiKey' => App::encrypt_decrypt('decrypt', $this->Credentials[0]),
        'password' => App::encrypt_decrypt('decrypt', $this->Credentials[1]),
        'secret' => App::encrypt_decrypt('decrypt', $this->Credentials[2])
      ]);

      if($this->Credentials[3] == 0) $this->Api->urls['api'] = 'https://api-public.sandbox.gdax.com';
    } else {
      $this->Api = new \ccxt\gdax([
