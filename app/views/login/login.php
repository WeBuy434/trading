...
<header>
  <img src="<?php echo APP_URL.'/assets/img/logo_black.svg'; ?>" alt="">
</header>
<section class="kr-login-act" act="<?php echo APP_URL; ?>/app/modules/kr-user/src/actions/login.php">
  <section class="kr-login-field">
    ...
    <footer>
      ...
      <input type="submit" class="btn-shadow" name="" value="<?php echo strtoupper($Lang->tr('Login')); ?>">
    </footer>
  </section>
  ...
  <section class="kr-login-oauth">
    <div class="">
      ...
      <?php if($App->_enableFacebookOauth()): ?>
        <a href="<?php echo $FacebookOauth->_getAuthorizationUrl(); ?>" class="btn-shadow btn-blue">
          <div class="kr-login-oauth-icn">
